...
VARIABLE_RENAMINGS = {
    ...
    ("radiation", 0): {"grad": "accumulated_global_radiation_W_m2", "nswrf":  "accumulated_direct_radiation_W_m2"},
}
...
def deaccumulate_radiation(ds: xr.Dataset) -> xr.Dataset:
    ds = ds.copy()
    accum_radiation = ds[["accumulated_global_radiation_W_m2", "accumulated_direct_radiation_W_m2"]]
    ...
    ds = ds.drop_vars(["accumulated_global_radiation_W_m2", "accumulated_direct_radiation_W_m2"])
...
def radiation_energy_to_power(ds: xr.Dataset) -> xr.Dataset:
    ds = ds.copy()
    ds[["global_radiation_W_m2", "direct_radiation_W_m2"]] = ds[["global_radiation_J_m2", "direct_radiation_J_m2"]] / (60*60)
