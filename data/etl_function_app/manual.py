...
file_list = file_system_client.get_paths("forecast_nwp_dmi_harmonie_dini_sf/schema_version=None/year=2024/month=06")
...
if __name__ == '__main__':
    with Pool(7) as p:
        print(p.map(write, file_list, chunksize=1))
